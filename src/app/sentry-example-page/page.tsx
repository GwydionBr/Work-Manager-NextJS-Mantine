  ...
  return (
    ...
    >
      <Center style={{ width: "100%" }}>
        <Stack gap="md" align="center" maw={600} px="md">
          <svg
            height="40"
            width="40"
            fill="none"
          ...
          <Text size="lg" ta="center" c="dimmed" maw={500}>
            ...
            <Anchor
              href="https://gwydion-97.sentry.io/issues/?project=4510289724702800"
              target="_blank"
            >
              Issues Page
            </Anchor>
          ...
          {hasSentError ? (
            <Alert color="green" title="Success" maw={500}>
              Error sent to Sentry.
            </Alert>
          ) : !isConnected ? (
            <Alert color="red" title="Connectivity Error" maw={500}>
              <Text>
